...
Las ecuaciones podrían ser resueltos multiplicando cada uno de ellos por $e^{\lambda t}$ e integrndo. Dado que $W_0(0)=1$ y $W_n(0)=0$, tenemos una sucesión:
\begin{align*}
  && W_0&= e^{-\lambda t},\\
...
Ya que $\frac{W_n}{W_{n-1}}=\frac{x}{n}$, este radio será mayor que $1$ siempre que $n<x$. Por lo tanto, si $n\le x$, %TODO el simbolo
\begin{equation*}
  W_n W_{n-1}%TODO el sombolo
\end{equation*}
