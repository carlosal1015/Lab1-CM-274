% arara: clean: {extensions: ['log','bbl','bcf','blg','run.xml','fls','fdb_latexmk','synctex.gz']}
% arara: xelatex: {shell: yes, synctex: yes}
% arara: xelatex: {shell: yes, synctex: yes}
% arara: clean: {extensions: ['log','aux','bbl','bcf','blg','run.xml','fls','fdb_latexmk','synctex.gz']}
